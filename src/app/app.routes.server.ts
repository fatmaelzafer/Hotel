...
export const serverRoutes: ServerRoute[] = [
  ...
  { path: 'guestview/home', renderMode: RenderMode.Server },
  { path: 'guestview/rooms', renderMode: RenderMode.Server },
  { path: 'guestview/roomsearch/:checkOut/:checkIn/:guests', renderMode: RenderMode.Server },
